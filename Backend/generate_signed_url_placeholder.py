# Placeholder for generate_signed_url.py
# Allows deploy.sh to replace placeholder with actual CloudFront domain
# Keeps old URLs from breaking when redeploying
